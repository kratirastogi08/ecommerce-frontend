...
import logo from "../../assets/Profile-PNG-Images.png";
...
function LoginSignUp() {
  ...
  const { error, loading, isAuthenticated ,user:loginuser} = useSelector(
    (state) => state.user
  );
